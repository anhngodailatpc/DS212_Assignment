...
ggplot()+geom_line(data=BRA_DATA_2tc_2020, aes(x=date, y=new_cases_tb,group=1,col="red"))+scale_x_discrete(breaks=c("2020-11-01","2020-12-01","2020-12-31"))+labs(title = "Bieu do the hien thu thap ca nhiem o Brazil thang 11,12/2020",x="Thoi gian", y="So ca nhiem moi")
ggplot()+geom_line(data=BRA_DATA_2tc_2021, aes(x=date, y=new_cases_tb,group=1,col="red"))+scale_x_discrete(breaks=c("2021-11-01","2021-12-01","2021-12-31"))+labs(title = "Bieu do the hien thu thap ca nhiem o Brazil thang 11,12/2021",x="Thoi gian", y="So ca nhiem moi")
