...
ggplot(BRA_DATA_Made_2020,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 07,09,10-2020 cua Brazil",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(BRA_DATA_Made_2021,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 01,07,09,10-2021 cua Brazil",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
...
ggplot(CHL_DATA_Made_2020,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 07,09,10-2020 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(CHL_DATA_Made_2021,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 01,07,09,10-2021 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(CHL_DATA_Made_2022,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao thang 01-2022 cua Chile",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
...
ggplot(VEN_DATA_Made_2020,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 07,09,10-2020 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(VEN_DATA_Made_2021,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao cac thang 01,07,09,10-2021 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
ggplot(VEN_DATA_Made_2022,(aes(x = dates, y = new_deaths_tb))) + geom_line(aes(color = month),group=1) +facet_wrap( ~ month)  +labs(title = "Bieu do the hien thu thap tu vong vao thang 01-2022 cua Venezuela",subtitle = "Theo trung binh 7 ngay gan nhat",y = "So ca tu vong",x = "Ngay",color = "Chu thich")+scale_x_discrete(breaks=c("10","20","31")) 
