...
View(vii_2020$V1)
View(max(vii_2020$V1))
#2020
plot(vii_2020$V1[1:31], type = "l", col = "red", ylim = c(0, max(vii_2020$V1)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2020")
lines(vii_2020$V1[32:62], col = "yellow", type = "l")
lines(vii_2020$V1[63:92], col = "green", type = "l")
lines(vii_2020$V1[93:123], col = "blue", type = "l")
...
#2021
plot(vii_2021$V1[1:31], type = "l", col = "red", ylim = c(0, max(vii_2021$V1)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2021")
lines(vii_2021$V1[32:62], col = "yellow", type = "l")
lines(vii_2021$V1[63:92], col = "green", type = "l")
lines(vii_2021$V1[93:123], col = "blue", type = "l")
...
#2022
plot(vii_2022$V1, type = "l", col = "red", ylim = c(0, max(vii_2022$V1)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2022")
