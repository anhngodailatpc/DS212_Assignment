...
#2020
plot(vii_2020$new_cases[1:31], type = "l", col = "red", ylim = c(0, max(vii_2020$new_cases)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2020")
...
#2021
plot(vii_2021$new_cases[1:31], type = "l", col = "red", ylim = c(0, max(vii_2021$new_cases)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2021")
...
#2022
plot(vii_2022$new_cases, type = "l", col = "red", ylim = c(0, max(vii_2022$new_cases)), xlab = "Day", ylab = "New cases", main = "New cases in the world in 2022")
