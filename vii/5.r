...
map1<-ggplot(world,aes(x=date,y=tan_so))+
       ...
       labs(title="Tháng 11 và 12, năm 2020", x="Ngày", y="%",subtitle="Nhiễm bệnh")
...
map2<-ggplot(world,aes(x=date,y=tan_so))+
  geom_line(col="red",size=2)+
  labs(title="Tháng 11 và 12, năm 2021", x="Ngày", y="%", subtitle="Nhiễm bệnh")
