#2020
  ...
  axis(1, at = c(0,31,62), labels = c("Jan", "Jul", "Sep"))
...
legend("topleft", legend = c("Brazil", "Chile", "Venezuela"), lty = 1, col = c("red","yellow", "green"), ncol = 1, bty = "o", text.col = c("red","yellow", "green"))
#2022
plot(brazil.2022$new_deaths, type = "l",xaxt="n", col = "red", ylim = c(0, max(brazil.2022$new_deaths)), xlab = "Month", ylab = "New deaths", main = "New deaths in 2022")
