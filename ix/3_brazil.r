...
ggplot(brazil_2020_9,(aes(x=new_cases_tb,y=new_deaths_tb)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 9/2020 cua Brazil") + geom_smooth()
print(cor(brazil_2020_9$new_cases_tb,brazil_2020_9$new_deaths_tb))

ggplot(brazil_2020_10,(aes(x=new_cases_tb,y=new_deaths_tb)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 10/2020 cua Brazil") +  geom_smooth()
print(cor(brazil_2020_10$new_cases_tb,brazil_2020_10$new_deaths_tb)) 
...
ggplot(brazil_2021_9,(aes(x=new_cases_tb,y=new_deaths_tb)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 9/2021 cua Brazil")+ geom_smooth()
print(cor(brazil_2021_9$new_cases_tb,brazil_2021_9$new_deaths_tb)) 

ggplot(brazil_2021_10,(aes(x=new_cases_tb,y=new_deaths_tb)))+geom_point(shape=1, color="blue")+facet_wrap( ~ month)+ggtitle("Bieu do tuong quan giua ca nhiem va tu vong thang 10/2021 cua Brazil")+  geom_smooth()
print(cor(brazil_2021_10$new_cases_tb,brazil_2021_10$new_deaths_tb)) 
